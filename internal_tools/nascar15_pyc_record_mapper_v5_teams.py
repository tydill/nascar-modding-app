    ...
    while i < len(code):
        ...
        try:
            if opname == "LOAD_CONST":
                ...
                # Python 2 stack order is defaults..., code object (TOS).
                # Pop the code object first, then its defaults.
                ...
                # Python 2 stack order is defaults..., closure tuple, code (TOS).
                # Pop code first, then the closure tuple, then the defaults.
                code_val = stack.pop() if stack else None
                if stack:
