...
def install_new_thumbnail(game_arg, uid: int, donor_uid: int, image_path,
...
def replace_existing_thumbnail(game_arg, uid: int, image_path,
                               target_container_name: str | None = None) -> dict:
    """Replace an existing thumbnail in the driver's current team bank."""
...
def install_or_replace_thumbnail(game_arg, uid: int, donor_uid: int, image_path,
                                 target_container_name: str | None = None) -> dict:
    if find_target(game_arg, uid, target_container_name):
        return replace_existing_thumbnail(game_arg, uid, image_path, target_container_name)
    return install_new_thumbnail(game_arg, uid, donor_uid, image_path, target_container_name)
