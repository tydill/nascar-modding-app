...
def load_modules():
    root = script_dir()
    mapper_path = root / "nascar15_pyc_record_mapper_v5_fixed.py"
    patcher_path = root / "nascar15_v11_probe_patcher.py"
    if not mapper_path.exists() or not patcher_path.exists():
        raise FileNotFoundError(
            "Put this probe in the Modding App folder beside "
            "nascar15_pyc_record_mapper_v5_fixed.py and nascar15_v11_probe_patcher.py"
        )
